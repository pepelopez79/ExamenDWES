...
<body>
    <div class="container">
        <div class="row mb-3">
            ...
            <div class="col-auto">
                <button class="btn btn-danger" onclick="generarPDF()" style="margin-left: 10px">Listado PDF</button>
            </div>
        </div>
        <div class="text-center">
        <p><h2>Listado de Estudiantes</h2></p>
        ...
        <table class="table table-striped" id="pdfTable">
            ...
            <?php
                foreach ($resultsQuery as $fila) {
                    ...
                    echo '<td><img src="../Images/' . $fila['fotografia'] . '" alt="Avatar" class="avatar-img" style="border-radius: 50%; width: 40px; height: 40px;"></td>';
                    echo '<td><a href="mostrar_expediente.php?id=' . $fila['id'] . '">Detalle</a> | <a href="editar_expediente.php?id=' . $fila['id'] . '">Editar</a> | <a href="eliminar_expediente.php?id=' . $fila['id'] . '">Eliminar</a></td>';
                    echo '</tr>';
                }
            ?>
        </table>
    ...
    <script>
        function generarPDF() {
            try {
                ...
                axios.get('datos_expedientes.php')
